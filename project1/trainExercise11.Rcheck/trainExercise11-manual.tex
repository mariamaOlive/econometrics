...
\chapter*{}
\begin{center}
{\textbf{\huge Package `trainExercise11'}}
\par\bigskip{\large \today}
\end{center}
\inputencoding{utf8}
\ifthenelse{\boolean{Rd@use@hyper}}{\hypersetup{pdftitle = {trainExercise11: What the Package Does (Title Case)}}}{}\begin{description}
\raggedright{}
